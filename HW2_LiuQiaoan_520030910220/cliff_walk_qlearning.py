...
if record_video:
    env = gym.wrappers.RecordVideo(env, video_folder = "./video", name_prefix = "qlearning")
else:
    env.render()
while True:
    a = agent.choose_action(s)
...
plt.savefig("./output/cliff_walk_qlearning.pdf")

## 2. epsilon list
plt.figure()
plt.plot(epsilon_list)
plt.savefig("./output/cliff_walk_qlearning_epsilon.pdf")
...
plt.savefig("./output/cliff_walk_qlearning_path.pdf")
##### END CODING HERE #####
